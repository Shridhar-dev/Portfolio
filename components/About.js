...
function About() {
    return (
        <div className="mx-10 md:mx-10 flex justify-center items-center flex-col  py-12 mt-4" >
            ...
            <div className="mx-0 px-6 md:mx-12 md:px-12" style={{color:'white',fontWeight:'400'}}>
                <h4 className="text-2xl mx-0 px-0 md:mx-24 md:px-24 " style={{lineHeight:'2.5rem'}}>I am a front end freelancer, having deep interest into
