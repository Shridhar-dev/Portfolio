...
function CSSGallery() {
    return (
        <div className="container d-flex flex-column align-items-center  py-5 mt-5">
            ...
            {/*First animated row*/}
            <div className="d-none d-md-flex mx-5 mx-md-0 mt-5 pt-2 justify-content-center align-items-center css-scroll" data-scroll data-scroll-speed="5" data-scroll-repeat data-scroll-direction="horizontal">               
            ...
            {/*Hidden animated row*/}
            <div className="d-flex d-md-none css-scroll">
                <CSSArt src={Crt.src}  width={200} alt="Img of an old CRT monitor made in Pure CSS"/>
                <CSSArt src={Stoa.src}  width={150} alt="Img of Stoa Logo made in Pure CSS"/>
                <CSSArt src={OldMan.src} alt="Img of Old Man Illustrations made in Pure CSS"/>
                <CSSArt src={Git.src} width={200} alt="Img of Git Logo made in Pure CSS"/>
